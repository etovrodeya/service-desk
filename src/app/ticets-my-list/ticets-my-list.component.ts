...
@Component({
  selector: 'app-ticets-my-list',
  templateUrl: `./ticets-my-list.component.html`,
  styles: []
})
export class TicetsMyListComponent implements OnInit {
  curStatus: string;
  message='';
  ...
  getMyTicetList(){
    this.ticetsService.getMyTicetsList().subscribe(data=>{
